...
interface ShortMakerEditorProps {
    ...
    userCredits: number;
    template: Template;
    initialIdea?: string; // Added prop for pre-filling
}
...
export const ShortMakerEditor: React.FC<ShortMakerEditorProps> = ({ onBack, onGenerate, userCredits, template, initialIdea }) => {
    ...
    useEffect(() => {
        // If initialIdea is present, we could auto-start, but letting the user review is better
