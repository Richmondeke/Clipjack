...
export interface Template {
  ...
  mode?: 'AVATAR' | 'FASHION_SHOOT' | 'SHORTS' | 'STORYBOOK' | 'UGC_PRODUCT' | 'TEXT_TO_VIDEO' | 'AUDIOBOOK' | 'IMAGE_TO_VIDEO' | 'TEXT_TO_IMAGE' | 'IMAGE_TO_IMAGE' | 'CLIPPING'; 
}
...
export interface Project {
  ...
  videoUrl?: string; 
  error?: string;
  type?: 'AVATAR' | 'UGC_PRODUCT' | 'TEXT_TO_VIDEO' | 'FASHION_SHOOT' | 'SHORTS' | 'STORYBOOK' | 'AUDIOBOOK' | 'IMAGE_TO_VIDEO' | 'TEXT_TO_IMAGE' | 'IMAGE_TO_IMAGE' | 'CLIPPING'; 
  cost?: number; 
  user_email?: string;
}
